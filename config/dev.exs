...
config :sme_interviews, SmeInterviewsWeb.Endpoint,
  ...
  watchers: [
    ...
    esbuild: {Esbuild, :install_and_run, [:transcription_worker, ~w(--sourcemap=inline --watch)]},
...
config :sme_interviews, SmeInterviewsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/sme_interviews_web/(live|views)/.*(ex)$",
      ~r"lib/sme_interviews_web/templates/.*(eex)$",
