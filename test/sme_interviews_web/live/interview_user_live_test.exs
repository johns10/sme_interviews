defmodule SmeInterviewsWeb.InterviewUserLiveTest do
  ...
  # @create_attrs %{"user_id" => "1", "interview_id" => "1"}
  # @update_attrs %{"user_id" => "2", "interview_id" => "2"}
  # @invalid_attrs %{"interview_id" => "", "user_id" => ""}
  ...
  #     assert index_live
  #            |> form("#interview_user-form", interview_user: @invalid_attrs)
  #            |> render_change() =~ "can&#39;t be blank"

  #     {:ok, _, html} =
  #       index_live
  #       |> form("#interview_user-form", interview_user: @create_attrs)
  #       |> render_submit()
  ...
  #     {:ok, _, html} =
  #       index_live
  #       |> form("#interview_user-form", interview_user: @update_attrs)
  #       |> render_submit()
  #       |> follow_redirect(conn, Routes.interview_user_index_path(conn, :index))
